...
- 最終得点 ＝ 決戦の得点 ＋ 残り戦略カウンター ＋ 残り手札ボーナス。

## 特徴

- 🎭 **仮面あて（読み）**：相手の伏せ札の属性をワンタップで予想。勝敗には影響しない独立したミニゲームとして、的中回数が記録に残る。看板の「読み合い」を能動的な一手に。
- 🃏 **段階的に解放されるルール**：初級（3色）→ 中級（＋AIR）→ 上級（＋KAOS）→ 本戦（入替・奇襲・終盤2倍・全ルール・成績記録）。
- 👑 **レベルの主（ライバル）と称号**：各レベルに専用AIのライバル騎士（三色の見習いアルル／風唄いのゼファ／仮面卿ノクス）。★クリア目標を集め、称号をアンロックして装備。
